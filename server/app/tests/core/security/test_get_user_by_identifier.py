...
from app.core.security import (
    _get_user_by_identifier,  # pyright: ignore[reportPrivateUsage]
)
...
async def test_get_user_by_identifier_with_email(
    ...
    result = await _get_user_by_identifier(collision_identifier, db_session)
...
async def test_get_user_by_identifier_with_email_fallback(
    ...
    result = await _get_user_by_identifier(identifier, db_session)
...
async def test_get_user_by_identifier_with_email_not_found(
    ...
    result = await _get_user_by_identifier("not_found@example.com", db_session)
