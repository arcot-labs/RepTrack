...
export const ExerciseSearchResultSchema = {
    properties: {
        id: {
            type: 'integer',
            title: 'Id'
...
export const MuscleGroupSearchResultSchema = {
    properties: {
        id: {
            type: 'integer',
            title: 'Id'
...
export const ReindexRequestSchema = {
    properties: {
        wait_for_tasks: {
            type: 'boolean',
